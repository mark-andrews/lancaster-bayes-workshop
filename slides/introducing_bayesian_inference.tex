...
\author[Andrews]{Mark Andrews \& Thom Baguley\\ $\phantom{foo}$ \\ Psychology, Nottingham Trent University \\ $\phantom{foo}$ \\ \faEnvelopeO \  \texttt{mark.andrews@ntu.ac.uk},\ \faEnvelopeO\  \texttt{thomas.baguley@ntu.ac.uk} \\ $\phantom{foo}$ \\ \faTwitter \href{https://twitter.com/xmjandrews}{@xmjandrews}, \faTwitter \href{https://twitter.com/seriousstats}{@seriousstats} \\ $\phantom{foo}$ \\ \faGithub \ \url{https://github.com/lawsofthought/lancaster-bayes-workshop}}
